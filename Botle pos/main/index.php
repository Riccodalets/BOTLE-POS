...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="user.php"><i class="icon-user icon-large"></i> Users</a></li>
			<li><a href="qoutation.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-user icon-large"></i> Qoutation</a></li>
			<li class="active"><a href="invoice.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-bar-chart icon-2x"></i> Invoice</a>                </li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Bottle Supply And Distribution</center></font>
<div id="mainmain">
