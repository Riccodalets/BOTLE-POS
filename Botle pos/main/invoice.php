...
if($position=='cashier') {
?>
<a href="invoice.php?id=cash&invoice=<?php echo $finalcode ?>">Cash</a>
...
<form action="incominginv.php" method="post" >
...
<a rel="facebox" href="checkoutinv.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $_SESSION['SESS_FIRST_NAME']?>"><button class="btn btn-success btn-large btn-block"><i class="icon icon-save icon-large"></i> SAVE</button></a>
