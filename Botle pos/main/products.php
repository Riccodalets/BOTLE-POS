...
<form method="post" action="import_file.php" enctype="multipart/form-data">
  <input type="submit" name="submit_file" value="Submit" class="btn btn-info" style="float:right; width:130px; height:35px;"/>
  <input type="file" name="file" class="btn btn-info" style="float:right; width:230px; height:35px; margin:0 10px;"/>
 </form>
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;margin:10px;" /><i class="icon-plus-sign icon-large"></i> Add Product</button></a><br><br>
