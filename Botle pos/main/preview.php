...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<div>Bottle Supply And Distribution	<br>
	Maseru 100, Lesotho	</div>
	<img src = "images/logos.jpg" alt="LOGO" style="width: 380px; " class="text-center">
	<div>
	<?php
	...
	<div style="width: 200kpx; float: left; height: 70px;">
